  ...
  render() {
    ...
    return (
      <HeaderContainer>
        ...
        <div>
          <p style={{color:`#808080`,fontWeight:`bold`,marginBottom:`0`}} onClick={this.showMenu}>
            MENU
          </p>
              ...
              ? (
                ...
                >
                  ...
                  >
                    ...
                    <MenuLink to={mobileMenuLink1}>About</MenuLink>
                    <MenuLink to={mobileMenuLink2}>Services</MenuLink>
                    <MenuLink to={mobileMenuLink3}>Gallery</MenuLink>
